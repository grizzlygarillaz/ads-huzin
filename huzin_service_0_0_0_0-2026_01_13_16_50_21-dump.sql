...
\restrict s6WBVjheQ2690KF0szIRjBZprh6UMSH2j5N2AADcxtDOwbvqIie4GNL3wSDzP8E
...
--
-- Data for Name: channel_types; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.channel_types (id, code, name) FROM stdin;
\.


--
-- Data for Name: channels; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.channels (id, uuid, name, identifier, settings, channel_type_id, project_uuid, created_at, updated_at, deleted_at) FROM stdin;
\.


--
-- Data for Name: cities; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.cities (id, name, country_code, lat, lng, timezone, population, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: city_names; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.city_names (id, language, name, is_preferred, is_short, city_id, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: files; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.files (id, disk, path, filename, mime_type, size, duration, width, height, created_at, updated_at) FROM stdin;
\.
...
4	2025_12_01_122322_create_uploads_table	1
5	2025_12_12_144835_create_personal_access_tokens_table	1
6	2025_12_17_125815_create_cities_table	1
7	2025_12_17_131524_create_projects_table	1
8	2025_12_18_113014_create_permission_tables	1
9	2025_12_18_150403_create_channels_table	1
10	2025_12_19_083752_create_template_table	1
11	2025_12_22_065124_create_publication_tables	1
\.
...
COPY public.projects (uuid, name, description, city_id, deleted_at, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: publication_channel_files; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.publication_channel_files (id, channel_id, file_id, external_id, meta, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: publication_external_ids; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.publication_external_ids (id, external_id, publication_id, stage, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: publication_file; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.publication_file (publication_id, file_id, "position", created_at) FROM stdin;
\.


--
-- Data for Name: publication_types; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.publication_types (id, name) FROM stdin;
\.


--
-- Data for Name: publications; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.publications (id, body, status, options, last_error, publication_type_id, channel_id, expires_at, scheduled_at, published_at, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: template_definitions; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_definitions (key, default_value, description, required, overridable, project_uuid, channel_id, created_at, updated_at, resolver) FROM stdin;
\.


--
-- Data for Name: template_param_types; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_param_types (id, name) FROM stdin;
\.


--
-- Data for Name: template_param_values; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_param_values (id, key, value, param_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: template_params; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_params (id, key, default_value, param_type_id, created_at, updated_at, resolver) FROM stdin;
\.


--
-- Data for Name: template_resolvers; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_resolvers (key, description, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: template_variable_params; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_variable_params (id, value, param_id, variable_id, param_value_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: template_variables; Type: TABLE DATA; Schema: public; Owner: sail
--

COPY public.template_variables (id, value, project_uuid, channel_id, created_at, updated_at, key, resolver) FROM stdin;
\.
...
COPY public.users (id, name, login, email, email_verified_at, password, remember_token, created_at, updated_at, deleted_at) FROM stdin;
\.


--
-- Name: channel_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.channel_types_id_seq', 1, false);


--
-- Name: channels_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--
...
--
-- Name: cities_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--
...
--
-- Name: city_names_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.city_names_id_seq', 1, false);
...
--
-- Name: files_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--
...
--
-- Name: publication_channel_files_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.publication_channel_files_id_seq', 1, false);


--
-- Name: publication_external_ids_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.publication_external_ids_id_seq', 1, false);


--
-- Name: publication_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.publication_types_id_seq', 1, false);


--
-- Name: publications_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--
...
--
-- Name: template_param_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.template_param_types_id_seq', 1, false);


--
-- Name: template_param_values_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.template_param_values_id_seq', 1, false);


--
-- Name: template_params_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.template_params_id_seq', 1, false);


--
-- Name: template_variable_params_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--

SELECT pg_catalog.setval('public.template_variable_params_id_seq', 1, false);


--
-- Name: template_variables_id_seq; Type: SEQUENCE SET; Schema: public; Owner: sail
--
...
\unrestrict s6WBVjheQ2690KF0szIRjBZprh6UMSH2j5N2AADcxtDOwbvqIie4GNL3wSDzP8E
