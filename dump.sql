...
\restrict omK28i9hbwCofd4JhyrgHEFFcvI8cTCSqEPl2NgLVM2MZpwWU94NiTkja6h1q56
...
--
-- Data for Name: channel_types; Type: TABLE DATA; Schema: public; Owner: root
--

COPY public.channel_types (id, name) FROM stdin;
\.
...
--
-- Data for Name: city_names; Type: TABLE DATA; Schema: public; Owner: root
--
...
4	2025_12_12_144835_create_personal_access_tokens_table	1
5	2025_12_15_082755_create_activity_log_table	1
6	2025_12_15_082756_add_event_column_to_activity_log_table	1
7	2025_12_15_082757_add_batch_uuid_column_to_activity_log_table	1
8	2025_12_17_125815_create_cities_table	1
9	2025_12_17_131524_create_projects_table	1
10	2025_12_18_113014_create_permission_tables	1
11	2025_12_18_150403_create_channels_table	1
12	2025_12_19_083752_create_variables_table	1
\.
...
COPY public.users (id, name, login, email, email_verified_at, password, remember_token, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: definitions; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.definitions (key, default_value, description, required, overridable, project_uuid, channel_id, created_at, updated_at, resolver) FROM stdin;
\.


--
-- Data for Name: param_types; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.param_types (id, name) FROM stdin;
\.


--
-- Data for Name: param_values; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.param_values (id, key, value, param_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: params; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.params (id, key, default_value, param_type_id, "order", created_at, updated_at, resolver) FROM stdin;
\.


--
-- Data for Name: resolvers; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.resolvers (key, description, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: variable_param_values; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.variable_param_values (id, value, param_id, variable_id, param_value_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: variables; Type: TABLE DATA; Schema: variable; Owner: root
--

COPY variable.variables (id, value, project_uuid, channel_id, created_at, updated_at, key, resolver) FROM stdin;
\.
...
--
-- Name: channel_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: city_names_id_seq; Type: SEQUENCE SET; Schema: public; Owner: root
--
...
--
-- Name: param_types_id_seq; Type: SEQUENCE SET; Schema: variable; Owner: root
--

SELECT pg_catalog.setval('variable.param_types_id_seq', 1, false);


--
-- Name: param_values_id_seq; Type: SEQUENCE SET; Schema: variable; Owner: root
--

SELECT pg_catalog.setval('variable.param_values_id_seq', 1, false);


--
-- Name: params_id_seq; Type: SEQUENCE SET; Schema: variable; Owner: root
--

SELECT pg_catalog.setval('variable.params_id_seq', 1, false);


--
-- Name: variable_param_values_id_seq; Type: SEQUENCE SET; Schema: variable; Owner: root
--

SELECT pg_catalog.setval('variable.variable_param_values_id_seq', 1, false);


--
-- Name: variables_id_seq; Type: SEQUENCE SET; Schema: variable; Owner: root
--

SELECT pg_catalog.setval('variable.variables_id_seq', 1, false);
...
\unrestrict omK28i9hbwCofd4JhyrgHEFFcvI8cTCSqEPl2NgLVM2MZpwWU94NiTkja6h1q56
